...
def build_custom_validation_batch(tokenizer, seq_len=seq_len, device=device, batch_size=4):
    query_strings = [
        "1. What is 17 + 35?",
        ...
        "10. What is the integral of a value x^2?",
        "11. What is the derivative of a vaue x^3 defined by the power law of calculus?",
        "12. What is the progression of time?"
    ]
    ...
    target_strings = [
        ...
        "7. A robot may not harm humanity, or, by inaction, allow humanity to come to harm,"
        ...
        "10. The integral of x^2 is (x^3)/3",
        "11. The derivative of x^3 by the power law becomes 3x^2",
        "12. Time marches ever forward, except in certain theoretical quantum dynamics,"
    ]
...
class ReasoningModelGUI:
    ...
    def training_loop(self):
        ...
        try:
            ...
            optimizers = [
                Muon(muon_params, lr=self.learning_rate.get(), momentum=0.95),  
                torch.optim.AdamW(adamw_params, lr=self.learning_rate.get(), betas=(0.90, 0.95), weight_decay=0.01)
            ]
