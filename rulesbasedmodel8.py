...
class ReasoningModelGUI:
    ...
    def load_trained_model(self):
        ...
        if os.path.exists(trained_model_path):
            self.model.load_state_dict(torch.load(trained_model_path))  # Load updated model
    ...
    def start_training(self):
        ...
        def run_training():
            self.training_process = subprocess.Popen(["torchrun", "--nnodes=1", "--nproc_per_node=2", "training_loop3.py", model_path, config_path])
    ...
    def stop_training(self):
        ...
        if self.training_process is not None:
            ...
            self.training_process.terminate()  # Gracefully stop
